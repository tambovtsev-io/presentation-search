...
{{
  ...
  "visual_content": "Основным визуальным элементом является большая информационная таблица, занимающая центральную часть слайда. \n\nСтруктура таблицы:\nКолонки таблицы:\n1. Основные программы кредитования\n2. Сумма займа, млн руб.\n3. Процентная ставка\n4. Макс. срок займа\n5. Общий бюджет проекта, млн руб.\n6. Софинансирование\n7. Специальные условия\n\nСодержание по строкам:\n1. Комплектующие изделия (1-й займ):\n- Сумма займа: 100–1 000 млн руб.\n- Ставка: 3% (банк. гарантия) / 5% базовая\n- Срок: 5 лет\n- Бюджет: от 125 млн руб.\n- Особые условия: целевые продажи ≥ 30% от займа\n\n2. Комплектующие изделия (2-й займ):\n- Сумма: 50–500 млн руб.\n- Ставка: 5%\n- Срок: 3 года\n- Особые условия: до 50% от первого займа\n\n3. Производительность труда:\n- Сумма: 50–300 млн руб.\n- Ставка: 3% (банк. гарантия) / 5% базовая\n- Срок: 5 лет\n- Бюджет: от 62.5 млн руб.\n- Софинансирование: ≥ 20%\n- Условия: рост производительности 10-30%\n\n4. Автокомпоненты:\n- Сумма: 100–5 000 млн руб.\n- Ставка: 3% (банк. гарантия) / 5% базовая\n- Срок: 7 лет\n- Для производства узлов и агрегатов\n\n5. Лизинг:\n- Сумма: 5–500 млн руб.\n- Ставка: 5%\n- Срок: 5 лет\n- Софинансирование: ≥ 55%\n- Условия: 10-90% от аванса лизинга\n\nОформление таблицы:\n- Чередующиеся цвета фона строк\n- Выравнивание числовых данных по правому краю\n- Текстовая информация выровнена по левому краю\n\nБрендинг:\n- Логотип ФРП размещен в правом верхнем углу\n- Внизу слайда присутствует подпись \"Ведущий российский стратегический консультант\"\n- Логотип и название \"Strategy Partners | strategy.ru\"\n- Номер слайда: 9",
