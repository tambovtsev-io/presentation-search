...
└── src/                    # Исходный код
    ...
    ├── run_descriptions.py # Скрипт для запуска пайплайна получения описаний
    ├── run_json2chroma.py  # Скрипт для запуска пайплайна векторизации описаний
    └── run_evaluation.py   # Скрипт для запуска валидации
